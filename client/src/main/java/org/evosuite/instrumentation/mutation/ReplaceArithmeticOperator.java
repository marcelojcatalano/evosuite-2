...
public class ReplaceArithmeticOperator implements MutationOperator {
    ...
    static {
        ...
        opcodesLong.addAll(Arrays.asList(Opcodes.LADD, Opcodes.LSUB,
                Opcodes.LMUL, Opcodes.LDIV, Opcodes.LREM));

        opcodesFloat.addAll(Arrays.asList(Opcodes.FADD, Opcodes.FSUB,
                Opcodes.FMUL, Opcodes.FDIV, Opcodes.FREM));

        opcodesDouble.addAll(Arrays.asList(Opcodes.DADD, Opcodes.DSUB,
