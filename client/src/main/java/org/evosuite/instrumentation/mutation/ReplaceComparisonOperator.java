...
public class ReplaceComparisonOperator implements MutationOperator {
    ...
    static {
        opcodesReference.addAll(Arrays.asList(Opcodes.IF_ACMPEQ,
                Opcodes.IF_ACMPNE));
        opcodesNull.addAll(Arrays.asList(Opcodes.IFNULL,
                Opcodes.IFNONNULL));
        opcodesInt.addAll(Arrays.asList(Opcodes.IFEQ, Opcodes.IFNE,
                Opcodes.IFGE, Opcodes.IFGT, Opcodes.IFLE, Opcodes.IFLT));
        opcodesIntInt.addAll(Arrays.asList(Opcodes.IF_ICMPEQ,
