...
import org.evosuite.runtime.util.MethodUtils;
...
public class URLUtil {
    ...
    static {
        try {
            ...
            hostAddressField = SafeReflection.findField(URL.class, "hostAddress");
            handlerField = SafeReflection.findField(URL.class, "handler");

            setMethod = MethodUtils.findMethod(URL.class, "set",
    ...
    public static void set(URL url, String protocol, String host, int port,
        ...
        MethodUtils.invoke(setMethod, "set", new Class[]{String.class, String.class, int.class, String.class, String.class, String.class, String.class, String.class},
